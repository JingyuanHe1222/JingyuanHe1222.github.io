...
- Built [**ClueWeb-Reco**](https://huggingface.co/datasets/cx-cmu/ClueWeb-Reco), a high-quality, privacy-preserving web recommendation dataset by mapping private U.S. browsing sequences to public webpages via large-scale dense semantic retrieval.
